$(document).ready(function () {
  ...
  let url = "http://localhost:8080/geoserver/testcsdl/wms?";
  let nameL1 = "hanoi4";
  ...
  map.on("click", function (event) {
    ...
    switch ($("input[name='HN']:checked").val()) {
      case "HN6":
        // Post - getInfoHN6
        ajaxfc(getInfoHN6, myPoint);
        break;

      case "HN8":
        // Post - getInfoHN8
        ajaxfc(getInfoHN8, myPoint);
        break;

      case "HSHN":
        // Post - getInfoHSHN
        ajaxfc(getInfoHSHN, myPoint);
        break;
      case "RHN":
        // Post - getInfoHSHN
        ajaxfc(getInfoRHN, myPoint);
        break;
      default:
...
var ajaxfc = (fcname, point) => {
  $.ajax({
    type: "POST",
    url: "api.js",

    data: { functionname: fcname, Point: point },
